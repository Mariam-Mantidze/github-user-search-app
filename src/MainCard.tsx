    ...
    <ResultCard>
      ...
      <div className="links-section">
        <div className="link-pair">
          ...
          <StyledSpan userData={userData} property="location">
        ...
        <div className="link-pair">
          ...
          <StyledSpan userData={userData} property="blog">
        ...
        <div className="link-pair">
          ...
          <StyledSpan userData={userData} property="twitter_username">
        ...
        <div className="link-pair">
          ...
          <StyledSpan userData={userData} property="company">
...
const ResultCard = styled.div`
  ...
  & .repos-follower-box {
    background: ${(props) => props.theme.repoBox};
    border-radius: 12px;
    display: flex;
    gap: 25px;
